...
(function () {
  ...
  function pt(e, t) {
    return (
      ...
      Object.getOwnPropertyDescriptors
        ...
        : Vr(Object(t)).forEach(function (a) {
  ...
  function mt(e) {
    ...
    if (
      (e.params.botnet && t.set("botnet", "true"),
  ...
  function xt(e, t, a) {
    var o = "https://challenges.cloudflare.com",
      c,
      l = (c = a == null ? void 0 : a.origin) !== null && c !== void 0 ? c : o;
    if (t) {
      var v;
  ...
  function wt(e, t, a, o, c, l, v, g, f) {
    ...
    return ""
      .concat(d, "/cdn-cgi/challenge-platform/")
      .concat(S, "turnstile/f/ov2/av0/rch")
      .concat(o, "/")
      .concat(e, "/")
      .concat(t, "/")
      .concat(a.theme, "/")
  ...
  var Et = function (e) {
      var t,
        ...
        c =
          e.state !== we.FailureFeedbackCode &&
          (e.state === we.FailureFeedback ||
            e.state === we.FailureHavingTroubles ||
            !e.errorCode),
        l,
        v = P(
          Ur,
          (l =
            (t = e.displayLanguage) === null || t === void 0
              ? void 0
              : t.toLowerCase()) !== null && l !== void 0
            ? l
            : "nonexistent",
        ),
        g,
  ...
  var zr =
    /^https:\/\/challenges(?:\.fed)?\.cloudflare\.com\/turnstile\/v0(\/.*)?\/api\.js/;
  function m(e, t) {
  ...
  function xr() {
    ...
    var o = { loadedAsync: !1, params: new URLSearchParams(), src: t, url: a };
  ...
  var Tt = function (e, t, a, o) {
      var c = xt(t.params, !1, o),
        ...
        g,
        f = ""
          .concat(c, "/cdn-cgi/challenge-platform/")
          .concat(l, "feedback-reports/")
          .concat(Ze(e), "/")
          .concat(t.displayLanguage, "/")
          .concat(
            (g = t.params.theme) !== null && g !== void 0 ? g : t.theme,
            "/",
          )
          .concat(a);
      ...
      ((S.className = "cf-wrapper-turnstile-feedback"),
        (S.style.display = "table-cell"),
        (S.style.verticalAlign = "middle"),
        (S.style.width = "100vw"),
        (S.style.height = "100vh"));
      var x = document.createElement("div");
      ((x.className = "cf-turnstile-feedback"),
        (x.id = "cf-fr-id"),
        (x.style.width = "100vw"),
      ...
      var D = function () {
        ...
        N = function () {
          ...
          (window.removeEventListener("resize", D),
            (k = d.parentNode) === null || k === void 0 || k.removeChild(d));
        },
      ...
      (E.setAttribute("tabindex", "0"),
        ...
        E.setAttribute("aria-label", "Close button icon"),
        (E.style.position = "absolute"),
        (E.style.width = "26px"),
        (E.style.height = "26px"),
        (E.style.zIndex = "2147483647"),
        (E.style.cursor = "pointer"),
        t.displayRtl ? (E.style.left = "24px") : (E.style.right = "24px"),
        (E.style.top = "24px"),
    ...
    wr = function (e) {
      var t, a, o, c;
      (c = document.getElementById(e)) === null ||
        c === void 0 ||
        (o = c.parentElement) === null ||
        o === void 0 ||
  ...
  function Ar(e, t, a) {
    for (
      ...
      if (v.nodeType === Node.ELEMENT_NODE) {
        ...
        try {
          for (
            var x = Array.from(g.attributes)[Symbol.iterator](), D;
            !(f = (D = x.next()).done);
            f = !0
          ) {
            var N = D.value;
        ...
        if (!(f.isComplete || f.isFailed || f.isResetting)) {
          var D = f.watchcat.seq - 1 - Jr,
            ...
            E =
              ...
              f.watchcat.overrunBeginSeq < A;
          if (
            ((f.isExecuting ||
              !f.isInitialized ||
              (f.isInitialized && !f.isStale && !f.isExecuted)) &&
              f.watchcat.lastAckedSeq !== 0 &&
              N) ||
            E
          ) {
          ...
          (d = x.contentWindow) === null ||
            d === void 0 ||
            d.postMessage(
              { event: "meow", seq: e.watchCatSeq, source: j, widgetId: g },
              "*",
            );
        }
      }
  ...
  function jt() {
    var e = [or, cr];
    (y.isRecaptchaCompatibilityMode && e.push(lr),
  ...
  function $r(e) {
    ...
    if (!(t === void 0 || t.hasResponseParamEl)) {
      ...
      var a,
        o = (a = t.params["response-field"]) !== null && a !== void 0 ? a : !0;
      if (o) {
        var c = document.createElement("input");
        c.type = "hidden";
        var l;
        ((c.name =
          (l = t.params["response-field-name"]) !== null && l !== void 0
            ? l
            : gt),
        ...
        var v;
        if (
          typeof t.params["response-field-name"] != "string" &&
          Fr((v = t.params.sitekey) !== null && v !== void 0 ? v : "")
        ) {
          var g = document.createElement("input");
          ((g.type = "hidden"),
            (g.name = yt),
            (g.id = "".concat(e, "_legacy_response")),
            t.wrapper.appendChild(g));
        }
      }
  ...
  function Lr(e, t) {
    ...
    if (
      (o !== null && U(o, HTMLInputElement) && (o.value = t),
      ...
      default:
        m(
          'Invalid value for parameter "mode", expected "'
            .concat(G.NonInteractive, '", "')
            .concat(G.Managed, '" or "')
            .concat(G.Invisible, '", got "')
            .concat(l, '"'),
          2818,
        );
    }
  ...
  function ta() {
    if (typeof window.PerformanceObserver == "function")
      try {
        ...
        try {
          for (
            var l = performance.getEntriesByType("resource")[Symbol.iterator](),
              v;
            !(a = (v = l.next()).done);
            a = !0
          ) {
  ...
  var qt = (function () {
    var e = function (n, i, r, u) {
        ...
        if (n.params.retry === Ee.Auto || r) {
          ...
          var u,
            s = r
              ? 0
              : 1e3 * 2 +
                ((u = n.params["retry-interval"]) !== null && u !== void 0
                  ? u
                  : 0);
      ...
      o = function (n) {
        if (!n) return [];
        for (
          var i = n.attributes, r = i.length, u = new Array(r), s = 0;
          s < r;
          s++
        )
          u[s] = i[s].name;
      ...
      c = function () {
        for (
          var n = {}, i = [], r = document.getElementsByTagName("*"), u = 0;
          u < r.length && i.length < 50;
          u++
        ) {
      ...
      g = function (n) {
        ...
        try {
          for (
            var s = y.widgetMap[Symbol.iterator](), h;
            !(i = (h = s.next()).done);
            i = !0
          ) {
            var w = De(h.value, 2),
      ...
      f = function (n, i, r) {
        for (; n.msgQueue.length > 0; ) {
          var u,
            s = n.msgQueue.pop();
          (u = r.contentWindow) === null ||
            u === void 0 ||
            u.postMessage({ event: s, source: j, widgetId: i }, "*");
        }
      },
      d = function (n, i) {
        if (i) {
      ...
      x = function (n, i) {
        ...
        if (u) {
          ...
          ((u.isResetting = !0),
            ...
            (u.watchcat.seq = 0),
            u.params.execution === Te.Render &&
              (u.msgQueue.push(de.Execute),
              (u.isExecuted = !0),
              (u.isExecuting = !0)));
          var h = ee(r),
            w = u.shadow.querySelector("#".concat(h));
          ((!h || !w) &&
            m("Widget ".concat(r, " to reset was not found."), 3330),
            u.params.appearance === Z.InteractionOnly && Mr(w),
          ...
          ((T.src = wt(
            ...
            (s = w.parentNode) === null || s === void 0 || s.replaceChild(T, w),
            Wt(h),
      ...
      D = function (n) {
        ...
        var u = ee(i),
          s = [
            "input#".concat(u, "_response"),
            "input#".concat(u, "_legacy_response"),
            "input#".concat(u, "_g_response"),
          ];
        (document.querySelectorAll(s.join(", ")).forEach(function (h) {
          ...
          r.wrapper.remove(),
          r.retryTimeout && window.clearTimeout(r.retryTimeout),
          y.widgetMap.delete(i),
          Ut(y));
      },
      N = function (n, i) {
        var r,
        ...
        if (typeof n == "string") {
          ...
          (w || m('Unable to find a container for "'.concat(n, '"'), 3585),
            (h = w));
        } else
          U(n, HTMLElement)
            ? (h = n)
        ...
        try {
          for (
            var B = y.widgetMap.values()[Symbol.iterator](), ne;
            !(T = (ne = B.next()).done);
            T = !0
          ) {
            var me = ne.value;
        ...
        if (z.startsWith("file:"))
          return m("Turnstile cannot run in a file:// url", 3608);
        var ye = ra(h);
        if (ye) {
          ...
          var ge;
          p.execution =
            (ge = p.execution) !== null && ge !== void 0 ? ge : Te.Render;
          var le;
          p.appearance =
            (le = p.appearance) !== null && le !== void 0 ? le : Z.Always;
          var Oe;
          p["retry-interval"] = Number(
            (Oe = p["retry-interval"]) !== null && Oe !== void 0 ? Oe : ur,
          );
          var ue;
          p["expiry-interval"] = Number(
            (ue = p["expiry-interval"]) !== null && ue !== void 0
              ? ue
              : (rr - ar) * 1e3,
          );
          var Ce;
          ...
          (typeof Y != "string" &&
            m(
              'Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(
                typeof Y == "undefined" ? "undefined" : W(Y),
                '"',
              ),
              3588,
            ),
            Cr(Y) ||
              m(
                'Invalid input for parameter "sitekey", got "'.concat(Y, '"'),
                3589,
              ),
            Mt(p.size) ||
              m(
          ...
          var Fe,
            se =
              (Fe = p["refresh-expired"]) !== null && Fe !== void 0
                ? Fe
                : re.Auto;
          Nt(se)
            ? (p["refresh-expired"] = se)
            : m(
                'Invalid type for parameter "refresh-expired", expected never|manual|auto, got "'
                  .concat(se, '" ')
                  .concat(typeof se == "undefined" ? "undefined" : W(se)),
                3603,
              );
          var Pe,
            H =
              (Pe = p["refresh-timeout"]) !== null && Pe !== void 0
                ? Pe
                : fe.Auto;
          Lt(H)
            ? (p["refresh-timeout"] = H)
            : m(
                'Invalid type for parameter "refresh-timeout", expected never|manual|auto, got "'
                  .concat(H, '" ')
                  .concat(typeof H == "undefined" ? "undefined" : W(H)),
                3603,
              );
          var V = document.createElement("iframe"),
            te = document.createElement("div"),
            he = te.attachShadow({ mode: "closed" });
          (Ct(ie) ||
            m(
              'Invalid input for optional parameter "action", got "'.concat(
                ie,
          ...
          if (!(!J || !_e)) {
            ...
            (lt || m("Turnstile Initialization Error ", 3606),
              (V.style.display = "none"),
              (V.style.border = "none"),
              (V.style.overflow = "hidden"),
              V.setAttribute(
                "src",
                wt(J, Y, p, $, !1, "b", X.New, y.scriptUrlParsed, mt(lt)),
              ),
              (V.onerror = function () {
                if (K) {
                  K == null || K(String(nr));
            ...
            (P(
              (ut =
                (u = document.featurePolicy) === null ||
                u === void 0 ||
                (r = u.features) === null ||
                r === void 0
                  ? void 0
                  : r.call(u)) !== null && ut !== void 0
                ? ut
                : [],
              _t,
            ) && Yt.push(_t),
              V.setAttribute("allow", Yt.join("; ")),
              V.setAttribute(
                "sandbox",
            ...
            var st;
            ((V.tabIndex =
              (st = p.tabindex) !== null && st !== void 0 ? st : 0),
              (V.title = "Widget containing a Cloudflare security challenge"),
              he.appendChild(V));
            var ft,
              Dr =
                (ft = p["response-field"]) !== null && ft !== void 0 ? ft : !0;
            if (Dr) {
              ...
              if (
                ((ze.name =
                  (dt = p["response-field-name"]) !== null && dt !== void 0
                    ? dt
                    : gt),
                (ze.id = "".concat(_e, "_response")),
                te.appendChild(ze),
                typeof p["response-field-name"] != "string" && Fr(Y))
              ) {
                var He = document.createElement("input");
                ((He.type = "hidden"),
                  (He.name = yt),
                  (He.id = "".concat(_e, "_legacy_response")),
                  te.appendChild(He));
              }
            }
            if (y.isRecaptchaCompatibilityMode) {
      ...
      A = function () {
        ...
        try {
          for (
            var h = y.widgetMap[Symbol.iterator](), w;
            !(r = (w = h.next()).done);
            r = !0
          ) {
            var T = De(w.value, 2),
            ...
            switch (z.label) {
              case 0:
                ...
                ((w = "h/".concat("b", "/")),
                  ...
                  (B = ""
                    .concat(R, "://")
                    .concat(T.host, "/cdn-cgi/challenge-platform/")
                    .concat(w, "rc/")
                    .concat(r)
                    .concat(M)),
                  (z.label = 1));
              case 1:
                return (
                  ...
                  [
                    4,
                    fetch(B, {
                      body: JSON.stringify({ secondaryToken: i, sitekey: s }),
            ...
            switch (n.event) {
              case "init": {
                ...
                (s ||
                  ...
                  (r.nextRcV = n.nextRcV),
                  r.mode === G.Invisible &&
                    r.params["refresh-expired"] === re.Manual &&
                    b(
                  ...
                  r.mode !== G.Managed &&
                    r.params["refresh-timeout"] !== fe.Auto &&
                    b(
                      "setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored.",
                    ),
                  r.params.appearance === Z.Always ||
                  (r.isExecuting && r.params.appearance === Z.Execute)
                    ? Bt(s, r)
                    : Mr(s),
                  (s.style.display = ""));
                ...
                (h ||
                  ...
                  (u = h.contentWindow) === null ||
                    u === void 0 ||
                    u.postMessage(
                      { event: "init", source: j, widgetId: n.widgetId },
                      "*",
                    ));
                break;
              }
              case "translationInit": {
                ...
                ((r.displayLanguage = n.displayLanguage),
                  ...
                  Object.keys(n.translationData).forEach(function (J) {
              ...
              case "fail": {
                ...
                if (z) {
                  var ye,
                    p = r.shadow.querySelector("#".concat(i));
                  p == null ||
                    (ye = p.contentWindow) === null ||
                    ye === void 0 ||
                    ye.postMessage(
                      { event: "forceFail", source: j, widgetId: n.widgetId },
                      "*",
                    );
                }
                if (me) {
                  var ie;
                  me(String((ie = n.code) !== null && ie !== void 0 ? ie : ir))
                    ? r.params.retry === Ee.Auto && !r.isResetting && t(r, i, z)
                    : (n.code && b("Error: ".concat(n.code, ".")), t(r, i, z));
                } else
                  n.code
                    ? (t(r, i, z), m("Error: ".concat(n.code), 3076))
                    : t(r, i, !1);
                break;
              }
              case "feedbackInit": {
              ...
              case "requestFeedbackData": {
                var Ie,
                  Y = r.shadow.querySelector("#".concat(i));
                (Y ||
                  m(
              ...
              case "turnstileResults": {
                var oe,
                  ce,
                  ge =
                    (oe = r.wrapper.parentNode) === null || oe === void 0
                      ? void 0
                      : oe.querySelector("#".concat(i, "-fr"));
                (ge ||
                  m(
                    "Received state for an unknown widget: ".concat(n.widgetId),
                    3078,
                  ),
                  (ce = ge.contentWindow) === null ||
                    ce === void 0 ||
                    ce.postMessage(
                      {
                        cfChlOut: r.cfChlOut,
              ...
              case "closeFeedbackReportIframe": {
                var le,
                  Oe =
                    (le = r.wrapper.parentNode) === null || le === void 0
                      ? void 0
                      : le.querySelector("#".concat(i, "-fr"));
                (Oe ||
                  m(
                    "Received state for an unknown widget: ".concat(n.widgetId),
                    3078,
              ...
              case "tokenExpired": {
                ...
                ((r.isExpired = !0),
                  (ue = r.cbExpired) === null ||
                    ue === void 0 ||
                    ue.call(r, Ce),
                  r.params["refresh-expired"] === re.Auto &&
                    !r.isResetting &&
                    x(X.AutoExpire, i));
                break;
              }
              case "interactiveTimeout": {
                ...
                if (
                  (We
                    ? We()
                    : r.params["refresh-timeout"] === fe.Never &&
                      !r.isResetting &&
                      b(
                  ...
                  r.params["refresh-timeout"] === fe.Auto && !r.isResetting)
                ) {
              ...
              case "interactiveBegin": {
                ...
                (Be ||
                  ...
                  (Me = r.cbBeforeInteractive) === null ||
                    Me === void 0 ||
                    Me.call(r),
                  r.params.appearance === Z.InteractionOnly && Bt(Be, r));
                break;
              }
              case "interactiveEnd": {
                var Ne;
                (Ne = r.cbAfterInteractive) === null ||
                  Ne === void 0 ||
                  Ne.call(r);
                break;
              }
              ...
              case "requestExtraParams": {
                ...
                if (
                  ...
                  if (V) {
                    ...
                    try {
                      var he;
                      H =
                        (he = localStorage.getItem(te)) !== null &&
                        he !== void 0
                          ? he
                          : void 0;
                    } catch (J) {}
                ...
                (H && H.length > pr && (H = void 0),
                  (K = Le.contentWindow) === null ||
                    K === void 0 ||
                    K.postMessage(
                      qe(
                        {
                          action: r.action,
                          apiJsResourceTiming: E
    ...
    function O(_) {
      ...
      var r;
      return (r = y.widgetMap.keys().next().value) !== null && r !== void 0
        ? r
        : null;
    }
    var k = {};
    return pt(qe({}, k), {
      ...
      execute: function (n, i) {
        ...
        if (s) {
          ...
          (s.isExpired &&
            ...
            s.isStale && (x(X.StaleExecute, h), (s.isExecuting = !0)),
            s.msgQueue.push(de.Execute),
            (s.isExecuted = !0));
          ...
          if (
            ...
            return;
          if (
            (s.isInitialized && f(s, r, T),
            s.isInitialized && s.params.appearance === Z.Execute && Bt(T, s),
            s.isExecuting)
          ) {
            var R;
            (R = T.contentWindow) === null ||
              R === void 0 ||
              R.postMessage({ event: "execute", source: j, widgetId: r }, "*");
          }
        }
      },
      getResponse: function (n) {
        ...
        var s = O(n);
        return (
          s || m("Could not find widget for provided container", 43778),
          (i = y.widgetMap.get(s)) === null || i === void 0
            ? void 0
            : i.response
        );
      },
      ...
      isExpired: function (n) {
        ...
        if (typeof n == "undefined") {
          ...
          if (r) {
            var u, s;
            return (s =
              (u = y.widgetMap.get(r)) === null || u === void 0
                ? void 0
                : u.isExpired) !== null && s !== void 0
              ? s
              : !1;
          }
          m("Could not find a widget", 43794);
          ...
          typeof n != "function" &&
            m(
              'turnstile.ready() expected a "function" argument, got "'.concat(
                typeof n == "undefined" ? "undefined" : W(n),
                '"',
              ),
              3841,
            ),
  ...
  function ra(e) {
    ...
    k
      ? (tt(k) ||
        ...
        (a["feedback-enabled"] = k === "true"))
      : (a["feedback-enabled"] = !0);
    var _,
      n =
        (_ = e.getAttribute("data-response-field")) !== null && _ !== void 0
          ? _
          : "true";
    ...
    s &&
      (tt(s) ||
        b(
          'Invalid data-offlabel-show-privacy value: "'.concat(
            s,
            '", expected "true" or "false".',
          ),
        ),
      (a["offlabel-show-privacy"] = s === "true"));
    var h = e.getAttribute("data-offlabel-show-help");
    return (
      h &&
        (tt(h) ||
          b(
            'Invalid data-offlabel-show-help value: "'.concat(
              h,
              '", expected "true" or "false".',
            ),
          ),
        (a["offlabel-show-help"] = h === "true")),
      a
    );
  }
  function aa() {
    ...
    (Ut(y, e),
      ...
      Ir(window.turnstile, y));
  }
  ((Se = !1),
    (I = xr()),
    (y.scriptWasLoadedAsync =
      (rt = I == null ? void 0 : I.loadedAsync) !== null && rt !== void 0
        ? rt
        : !1),
    (y.scriptUrl =
      (at = I == null ? void 0 : I.src) !== null && at !== void 0
        ? at
        : "undefined"),
    (y.scriptUrlParsed = I == null ? void 0 : I.url),
    I != null &&
      I.params &&
      ((Ae = I.params.get("compat")),
      (Ae == null ? void 0 : Ae.toLowerCase()) === "recaptcha"
        ? window.grecaptcha
          ? b(
          ...
          : (b("Compatibility layer enabled."),
            ...
            (window.grecaptcha = qt))
        : Ae !== null &&
          b('Unknown value for api.js?compat: "'.concat(Ae, '", ignoring.')),
      I.params.forEach(function (e, t) {
        P(["onload", "compat", "_cb", "_upgrade", "_reload", "render"], t) ||
          b(
      ...
      (Se = I.params.get("_upgrade") === "true"),
      (Q = I.params.get("onload")),
      Q &&
        !Se &&
        setTimeout(function () {
          typeof ve[Q] == "function"
            ? ve[Q]()
            : (b(
    ...
    Ht && !Se
      ...
      : (Ht &&
          Se &&
          (Or(window.turnstile, y),
          Vt(y),
          (I == null || (nt = I.params) === null || nt === void 0
            ? void 0
            : nt.get("render")) !== "explicit" && setTimeout(jt, 0)),
        (window.turnstile = qt),
        Se ||
          ((I == null || (it = I.params) === null || it === void 0
            ? void 0
            : it.get("render")) !== "explicit" && Gt.push(jt),
          document.readyState === "complete" ||
          document.readyState === "interactive"
            ? setTimeout(kr, 0)
            : window.addEventListener("DOMContentLoaded", kr))),
    (Nr = 10800 * 1e3),
    window.setTimeout(aa, Nr));
